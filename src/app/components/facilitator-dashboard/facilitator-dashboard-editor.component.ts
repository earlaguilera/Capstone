...
@Component({
  selector: 'app-facilitator-dashboard-editor',
  templateUrl: './facilitator-dashboard-editor.component.html',
  styleUrls: ['./facilitator-dashboard.component.css']
})
export class FacilitatorDashboardComponentEditor implements AfterViewInit, OnInit {
